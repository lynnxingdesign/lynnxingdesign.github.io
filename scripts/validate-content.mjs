...
for (const project of content.projects) {
  ...
  for (const field of ['slug', 'brand', 'title', 'year', 'summary']) checkText(project[field], `${project.slug}.${field}`);
  assert(typeof project.category === 'string', `${project.slug}.category must be text`);
